...
<ul>
 ...
 <li><a href="waterlevel_hillsboroinlet.jpg" target="_blank"> Hillsboro station (D)</a></li> 
  ...
  <p>
Real time model developed using Delft3D hydrodynamic module. Click on station names to see model data at these following stations. Model results have been compared at South Port Everglades stations (A) as NOAA buoy is placed here.
    .</p>
  </div>
